<div class="mt-5 mb-5">
    <h2 class="text-center mt-4 mb-4">Топ-10 мастеров Москвы</h2>
    
    <div class="row gx-4">
        <div class="col-12 col-md-4 mt-2 mb-4">
            <div class="badge-block">
                <div class="badge-free-exit">Выезд бесплатно</div>
                <div class="badge-warranty">Даёт гарантию</div>
            </div>
            <div class="border p-4 rounded">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 mt-2">
                        ...
                        <li class="list-group-item"><b>Образование:</b> Санкт-Петербургский политехнической университет</li>
                        </ul>
