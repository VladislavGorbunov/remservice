...
<div class="row mt-3">
    ...
    <div class="mb-3">
        ...
        placeholder="Например: Занимаюсь ремонтом стиральных и посудомоечных машин более 10 лет. Выезжаю в день обращения, все необходимые запчасти беру с собой. На все виды работ даю гаранию 1 год.">{{ $user->aboutme }}</textarea>
    </div>
